...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("alephbert_experiment.log"),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class AlephBERTEmpathyScorer:
    def __init__(self):
        """Initialize the AlephBERT model and tokenizer for empathy scoring"""
        logger.info("Initializing AlephBERT model and tokenizer")
        ...
        # Define empathetic expressions in Hebrew
        ...
        logger.info("AlephBERT empathy scorer initialized successfully")

    def _get_embedding(self, text):
        """
        Get embedding for a text string using AlephBERT
        """
...
def batch_process_dialogs(dialog_dir="dialog_text", output_dir="alephBERT_exp"):
    """
    Process all dialog files and compute empathy scores using AlephBERT
    ...
    # Initialize AlephBERT scorer
    scorer = AlephBERTEmpathyScorer()
    ...
    # Save results to CSV
    detailed_csv_path = os.path.join(output_dir, "alephbert_empathy_detailed.csv")
    session_csv_path = os.path.join(output_dir, "alephbert_empathy_by_session.csv")
...
if __name__ == "__main__":
    ...
    output_dir = "alephBERT_exp"
    
    logger.info("Starting AlephBERT empathy analysis experiment")
    ...
    logger.info("AlephBERT empathy analysis experiment completed")