...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("multilingual_english_experiment.log"),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class MultilingualEnglishEmpathyScorer:
    def __init__(self):
        """Initialize the multilingual model and tokenizer for empathy scoring on English text"""
        logger.info("Initializing multilingual model and tokenizer for English text")
        
        # Use the same XLM-RoBERTa model for consistency with the previous experiment
        ...
        # Define empathetic expressions in English (translations of the Hebrew phrases)
        ...
        logger.info("Multilingual English empathy scorer initialized successfully")
...
def batch_process_dialogs(dialog_dir="translated_text", output_dir="multilingual_english_exp"):
    """
    Process all English dialog files and compute empathy scores using multilingual model
    ...
    scorer = MultilingualEnglishEmpathyScorer()
    ...
    # Save results to CSV
    detailed_csv_path = os.path.join(output_dir, "multilingual_english_empathy_detailed.csv")
    session_csv_path = os.path.join(output_dir, "multilingual_english_empathy_by_session.csv")
...
if __name__ == "__main__":
    ...
    output_dir = "multilingual_english_exp"
    
    logger.info("Starting multilingual English empathy analysis experiment")
    ...
    logger.info("Multilingual English empathy analysis experiment completed")